...
const CollegeStaffDashboard: React.FC = () => {
  ...
  const fetchDashboardData = React.useCallback(async () => {
    try {
      ...
      const statsResponse = await fetch('/api/college-staff/dashboard', {
        headers: {
  ...
  if (loading) {
    return (
      <CollegeStaffLayout title="College Staff Dashboard">
  ...
  // College staff have limited permissions - mostly view-only access
  const quickActions = [
    {
      name: 'View Students',
      description: 'View student information and progress',
      icon: UserGroupIcon,
      href: '/college-staff/students',
      color: 'bg-blue-600 hover:bg-blue-700',
    },
    {
      name: 'View Exams',
      description: 'View exam details and status',
      icon: ClipboardDocumentListIcon,
      href: '/college-staff/exams',
  ...
  return (
    <CollegeStaffLayout title="College Staff Dashboard">
      <div className="space-y-6">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">College Staff Dashboard</h1>
          {college && (
            <p className="text-gray-600">
              Welcome to {college.name} ({college.code}) staff panel
            </p>
          )}
        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>
                  As a college staff member, you have view-only access to most features. 
                  Contact your college administrator for additional permissions.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center text-sm text-gray-500">
                ...
                Viewing {stats?.totalStudents || 0} students
              </div>
              <div className="flex items-center text-sm text-gray-500">
                <div className="w-2 h-2 bg-purple-400 rounded-full mr-3"></div>
                Monitoring {stats?.totalExams || 0} exams
              </div>
            </div>
          </div>
        </div>
