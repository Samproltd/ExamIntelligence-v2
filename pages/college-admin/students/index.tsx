...
const CollegeAdminStudents: React.FC = () => {
  ...
  const fetchStudents = async () => {
    try {
      ...
      const response = await fetch('/api/college-admin/students', {
        headers: {
  ...
  if (loading) {
    return (
      <CollegeAdminLayout title="Manage Students">
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">View and manage student accounts in your college</p>
          </div>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-md">
          <div className="px-4 py-5 sm:px-6">
            ...
            <p className="mt-1 max-w-2xl text-sm text-gray-500">Manage all students in your college</p>
          </div>
